...
@DGMessageService
public class InGameChaServer extends GameServer{
	private static final Logger logger = LoggerFactory.getLogger(InGameChaServer.class);
	public int GetProtocol() {
		// TODO Auto-generated method stub
		return GameProtocol.GAME_CHA;
	}
	...
	public BaseMessage handle(IoSession is,BaseMessage request) {
		...
		r.getGameLogic().ChaBrand(pm.getRoom().getGameLogic().GetPlayerIndex(pm));
